        ...
        <div class="sidebar-content">
            <div class="nav-container">
                <nav id="main-menu-navigation" class="navigation-main">
                    ...
                    <div class="nav-item active">
                        <a href="/users"><i class="ik ik-bar-chart-2"></i><span>USERS</span></a>
                    </div>
                    <div class="nav-item">
                        <a href="/categories"><i class="ik ik-menu"></i><span>CATEGORIES</span> </a>
                    </div>
                    <div class="nav-item">
                        <a href="/expenses"><i class="ik ik-layers"></i><span>EXPENSES</span></a>
...
--}}
                   {{-- <div class="nav-item has-sub">
                    ...
                    <div class="nav-item">
                        <a href="pages/form-picker.html"><i class="ik ik-terminal"></i><span>Form Picker</span>
                            <span class="badge badge-success">New</span></a>
                    </div>

                    <div class="nav-lavel">Tables</div>
                    <div class="nav-item">
                        <a href="pages/table-bootstrap.html"><i
