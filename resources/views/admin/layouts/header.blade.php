...
<head>
    ...
    <title>Expense app - Admin Template</title>
    ...
    <link rel="stylesheet" href="{{asset('template/plugins/datatables.net-bs4/css/dataTables.bootstrap4.min.cs')}}'">
                            ...
                            <div class="notifications-wrap">
                                ...
                                <a href="#" class="media">
                                    ...
                                    <span class="media-body">
                                                ...
                                                <span
                                                    class="media-content">Meeting with Nathan on Friday 8 AM ...</span>
                                            </span>
                                </a>
                            </div>
                    ...
                    <div class="dropdown">
                        <a class="dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false"><img class="avatar"
                                                                           src="{{asset('template/img/user.jpg')}}"
                                                                           alt=""></a>
